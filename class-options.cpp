...
settings::settings()
{
	...
	registerObject(PERIP_IGNORE_TIME = entTime("perip-p_ignore-time", 0, MAX_INT, 300));
	registerObject(SYNFLOOD_MAX_CONNS = entInt("synflood-max-conns", 1, MAX_INT, 100));
	registerObject(SYNFLOOD_IGNORE_TIME = entTime("synflood-p_ignore-time", 0, MAX_INT, 300));
